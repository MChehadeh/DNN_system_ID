...
opt_tuning_rule_ise.beta=0.15;
opt_tuning_rule_ise.pm=30;
...
opt_tuning_rule_ise.beta_max=0.9;

opt_tuning_rule_iae=TuningRule;
opt_tuning_rule_iae.rule_type=TuningRuleType.pm_based;
opt_tuning_rule_iae.beta=-0.7;%-0.6475;
opt_tuning_rule_iae.pm=20;%22;
...
quad_vel.findOptTuningRule(opt_tuning_rule_ise)
...
list_of_processes=generateProcessObjects('SOIPTD', 1, linspace(0.015,0.3,4),linspace(0.2, 2, 4),linspace(0.0005, 0.1, 4), opt_tuning_rule_iae, []);
[optProc, list_of_deter]=getOptimalTuningRuleFromProcesses(list_of_processes);
%% Testing generateProcessObjects FOIPTD_outer
list_of_processes=generateProcessObjects('FOIPTD_outer', 1, linspace(0.2,6,3),[1],linspace(0.0005, 0.1, 3), opt_tuning_rule_iae, quad_att);
[optProc, list_of_deter]=getOptimalTuningRuleFromProcesses(list_of_processes);
%% Testing generateProcessObjects FOPTD_outer
list_of_processes=generateProcessObjects('FOPTD_outer', 1, linspace(0.2,6,3),[1],linspace(0.0005, 0.1, 3), opt_tuning_rule_ise, quad_att);
[optProc, list_of_deter]=getOptimalTuningRuleFromProcesses(list_of_processes);