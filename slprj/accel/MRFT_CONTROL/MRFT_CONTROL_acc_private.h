...
#ifndef RTW_HEADER_MRFT_CONTROL_acc_private_h_
#define RTW_HEADER_MRFT_CONTROL_acc_private_h_
#include "rtwtypes.h"
...
MRFT_CONTROL_acc_rt_TDelayInterpolate ( real_T tMinusDelay , real_T tStart ,
