...
for i=31:40%length(inner_loop_processes.list_of_discrete_processes)
    fprintf('Inner loop system IDa %.4f \n', i)
    mkdir('output_files/' + string(i) + '_vel')
    ...
    list_of_scattered_processes=generateProcessObjects(outer_process_type, 1, linspace(range_of_T1(1), range_of_T1(2), 3), [1], linspace(range_of_tau(1), range_of_tau(2), 3), tuning_rule_PI, inner_loop_process_i);
    ...
    save("output_files/"+string(i)+"_vel/distinguishing_phase.mat", "optTuningRule", "optProc", "list_of_deter");
    ...
    pivot_processes=generateProcessObjects(outer_process_type, 1, range_of_T1, [1], range_of_tau, tuning_rule_PI, inner_loop_process_i);
    ...
    save("output_files/"+string(i)+"_vel/discrete_processes.mat", "discrete_T1_values", "discrete_tau_values", "list_of_outer_loop_processes");
    ...
    fprintf('Done \n')
    save("output_files/"+string(i)+"_vel/joint_cost.mat", "joint_cost_matrix")
    ...
    fprintf('Generating Joint Cost Matrinx ...')
    save("output_files/"+string(i)+"_vel/training_data.mat", "MRFT_responses_training");
