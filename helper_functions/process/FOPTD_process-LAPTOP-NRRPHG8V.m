classdef FOPTD_process < Process
    properties
        
    end
   methods      
     function obj = FOPTD_process(obj)
          obj.sysOrder = 1;
          obj.num_of_integrators = 0;
     ...
     function [obj,Q,t,y]=getStep(obj,PIDcontroller_obj)
          ...
          load_system("PD_controller_for_FOPTD_parametric.slx")
          set_param('PD_controller_for_FOPTD_parametric','FastRestart','on');
          options = simset('SrcWorkspace','current');
          simOut = sim('PD_controller_for_FOPTD_parametric.slx',[],options);
