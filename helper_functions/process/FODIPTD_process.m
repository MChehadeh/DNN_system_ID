classdef FODIPTD_process < Process
    properties
        
    end
   methods      
     function obj = FODIPTD_process(obj)
         if nargin > 0
          obj.sysOrder = 1;
     ...
     function [obj,Q,t,y]=getStep(obj,PIDcontroller_obj)
          ...
          load_system("PD_controller_for_FODIPTD_parametric.slx")
          set_param('PD_controller_for_FODIPTD_parametric','FastRestart','on');
          options = simset('SrcWorkspace','current');
          simOut = sim('PD_controller_for_FODIPTD_parametric.slx',[],options);
          ...
          Simulink.sdi.clear; % This is important to prevent Simulink from eating disk space
     end
