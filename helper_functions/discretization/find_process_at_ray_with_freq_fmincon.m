function [process] = find_process_at_ray_with_freq_fmincon(process_seed,beta,target_freq,tolerance,use_MRFT)
%FIND_PROCESS_AT_RAY_WITH_FREQ Find the process at a specific ray with
%desired specific frequency !!!NOT WORKING!!!
...
cost_fun=@(x)get_exact_MRFT_err_abs(x, {process_seed,beta,target_freq});
current_freq=0;
r_bias=0;
r_scale=0;
