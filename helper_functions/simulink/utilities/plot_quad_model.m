...
Quad.X_arm = patch('xdata',Quad.X_armX,'ydata',Quad.X_armY,'zdata',2.5*Quad.X_armZ,'facealpha',.9,'facecolor','b');
Quad.Y_arm = patch('xdata',Quad.Y_armX,'ydata',Quad.Y_armY,'zdata',2.5*Quad.Y_armZ,'facealpha',.9,'facecolor','b');
