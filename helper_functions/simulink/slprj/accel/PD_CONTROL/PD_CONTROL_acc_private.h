...
#ifndef RTW_HEADER_PD_CONTROL_acc_private_h_
#define RTW_HEADER_PD_CONTROL_acc_private_h_
#include "rtwtypes.h"
...
PD_CONTROL_acc_rt_TDelayInterpolate ( real_T tMinusDelay , real_T tStart ,
