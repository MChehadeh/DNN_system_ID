function [normalized_control_timeseries_output, normalized_error_timeseries_output, scaled_gain_output, relay_bias_output] = MRFT_NN_preprocess(enable, control_timeseries, error_timeseries, target_relay_output)
