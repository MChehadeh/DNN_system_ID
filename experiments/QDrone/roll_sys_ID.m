...
%load('MRFT_Stabilizer_16-Apr_attitude.mat')
MRFT_command = stabilizer_data(44,:);
...
MRFT_command = stabilizer_data(44, start_index:end_index);
MRFT_u = stabilizer_data(45,start_index:end_index);
MRFT_error = -stabilizer_data(46, start_index:end_index);
