...
%load('MRFT_Commander_27-May-pos_y.mat')
MRFT_command = commander_data(42,:);
% start_index = 8941;
% end_index = 12560;
...
MRFT_command = commander_data(42, start_index:end_index);
MRFT_u = commander_data(43,start_index:end_index);
MRFT_error = -commander_data(44, start_index:end_index);
