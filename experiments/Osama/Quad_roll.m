...
%%
%upsampling
times_u = controller_output_3_t * 1e6;
times_roll = roll_t * 1e6;
times_upsampled = min(roll_t)*1e6:0.001:max(roll_t)*1e6;
MRFT_u = interp1(times_u, controller_output_3, times_upsampled, 'nearest');
MRFT_error = interp1(times_roll, roll, times_upsampled, 'cubic');
